...
How to install?
1. Install .exe and .dll files.
2. Disable Windows Defender [Need to process crack]
3. Copy files from archive to VoiceMod folder.
4. Open VoiceMod using new .exe launcher.
5. Done!
